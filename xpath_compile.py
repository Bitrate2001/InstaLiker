...
###############################################################################
# Note:
# If something went wrong, try to search and update the Xpath of an element.
###############################################################################
...
xpath["get_following_status"] = {
    "follow_button_XP": "//button[text()='Following' or \
     ...
     "follow_span_XP_following": "//button//*[local-name() = 'svg' and @aria-label='Following']",
}
...
xpath["like_image"] = {
    "like": '/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/section/main/div/div/div[3]/div/div[1]/div/div[1]/span[1]/div/div/span/*[name()="svg"][@aria-label="Like"]',
    "unlike": '/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/section/main/div/div/div[3]/div/div[1]/div/div[1]/span[1]/div/div/span/*[name()="svg"][@aria-label="Unlike"]',
...
xpath["login_user"] = {
    ...
    "login_elem": "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/section/main/article/div/div/div/div/div[2]/div[3]/button[1]/div",
    "login_elem_no_such_exception": "//a[text()='Log in']",
    "login_elem_no_such_exception_2": "//div[text()='Log in']",
    "login_elem_no_such_exception_3": "//input[@type='submit']",
    "nav": "//nav",
    ...
    "explore": "//div[*[local-name()='svg']/@aria-label='Explore']",
}

xpath["explore_section"] = {
    "first_explore_post": "//div/a[contains(@href,'/p/')]/div",
    "next_button": "//span[*[local-name()='svg']/@aria-label='Next']",
}
...
xpath["accept_igcookie_dialogue"] = {"accept_button": "/html/body/div[5]/div[1]/div/div[2]/div/div/div/div/div[2]/div/button[1]"}
